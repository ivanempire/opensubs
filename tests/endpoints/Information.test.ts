import Information from "../../src/endpoints/Information";
...
describe("Information", () => {
    ...
    it("correctly returns subtitle format response", async() => {
        ...
        expect(formatResponse.value.data).toHaveProperty("output_formats");
        expect(formatResponse.value.data.output_formats).toStrictEqual(["srt", "sub", "mpl", "webvtt", "dfxp", "txt"]);
    });
    ...
    it("correctly returns subtitle languages response", async() => {
        ...
        expect(formatResponse.ok).toBeTruthy();
        expect(formatResponse.value).toHaveProperty("data");
        expect(formatResponse.value.data).toStrictEqual( [
            {
                "language_code": "af",
    ...
    it("correctly returns user information response", async() => {
        ...
        expect(formatResponse.ok).toBeTruthy();
        expect(formatResponse.value).toHaveProperty("data");
        expect(formatResponse.value.data).toHaveProperty("allowed_downloads");
        expect(formatResponse.value.data).toHaveProperty("level");
        expect(formatResponse.value.data).toHaveProperty("user_id");
        expect(formatResponse.value.data).toHaveProperty("ext_installed");
        expect(formatResponse.value.data).toHaveProperty("vip");
        expect(formatResponse.value.data).toHaveProperty("downloads_count");
        expect(formatResponse.value.data).toHaveProperty("remaining_downloads");
    });
});